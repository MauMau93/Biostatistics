...
iii) No CI that include cero....so all  of the differences are significative?
...
Let´s check the expected counts for the contingency table.
...
With this test, we check if the probability that a person was on a real treatment, given that his discomfort was a certain one, and the probability that a person was in the placebo treatment, given that his discomfort ie other. 
